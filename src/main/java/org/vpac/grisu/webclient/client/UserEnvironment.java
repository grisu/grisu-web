...
KillingJobsFinishedEvent.Handler {
	...
	private final Map<String, GrisuJob> jobMap = new HashMap<String, GrisuJob>();
	private final Timer jobListRefreshTimer;

	private final int jobListRefreshInMilliSeconds = 100000;
